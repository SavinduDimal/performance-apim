...
#
# ----------------------------------------------------------------------------
# Run AI API performance tests on AWS Cloudformation Stacks
# ----------------------------------------------------------------------------
...
export application_name="WSO2 API Manager AI API"
export ec2_instance_name="wso2am"
export metrics_file_prefix="apim"
export run_performance_tests_script_name="run-ai-api-performance-tests.sh"
